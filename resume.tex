...
\cvpersonalinfo{
	...
	\begin{itemize}[leftmargin=*]
		...
		\item Monkey C / Haskell hobbyist
	\end{itemize}
}
...
\cvitem{
    ...
    \begin{itemize}[leftmargin=*]
       ...
       \item Developed backend logic for experimental features 
	    \begin{itemize}[leftmargin=*]
		    \item Documents tagging/categorization
		    \item Document uploads
		    \item Creating invoices
	    \end{itemize}
       using Erlang/OTP, Cowboy, and Riak
    \end{itemize}
}
