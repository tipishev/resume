...
\cvitem{
    ...
    \cvtitle{Associate Engineering Manager, Batch Variables}

    \begin{itemize}[leftmargin=*]
       \item Managing a team of 4 data engineers, owning technical excellence and compliance
       \item Building high cardinality pipelines with PySpark, Terraform, and AWS Glue/Athena
       \item Establishing and maintaining relations with other teams in the org
    \end{itemize}
}
